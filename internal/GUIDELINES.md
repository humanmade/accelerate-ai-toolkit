...
- **Missing journal.** If no learning journal exists yet (v1.2 feature), skip journal consultation and proceed with generic best practices. Mention that recommendations will improve over time as the toolkit learns what works on their site.
